...
export interface EmployerApplicationDetail {
  ...
  employer_name: string | null;  // Mapped from legal_name or trade_name
  legal_name: string | null;
  trading_name: string | null;   // Mapped from trade_name
  employer_email: string | null;
  business_type: string | null;  // Mapped from ownership_name
  industry_type: string | null;  // Mapped from industry_name
  tax_id: string | null;
  registration_date: string | null;  // Mapped from date_incorporated
  
  // Step 2: HQ Address
  address_line1: string | null;  // Mapped from hq_address1
  address_line2: string | null;  // Mapped from hq_address2
  ...
  mailing_address_line1: string | null;  // Mapped from mailing_address1
  mailing_address_line2: string | null;  // Mapped from mailing_address2
  ...
  phone: string | null;           // Mapped from contact_telephone
  phone_country: string | null;   // Mapped from contact_telephone_country
  phone_dial_code: string | null; // Mapped from contact_telephone_dial_code
  fax: string | null;             // Mapped from contact_fax
  fax_country: string | null;     // Mapped from contact_fax_country
  fax_dial_code: string | null;   // Mapped from contact_fax_dial_code
...
function normalizeEmployerDetail(raw: Record<string, unknown>): EmployerApplicationDetail {
  return {
    ...
    // Step 1: Employer Profile
    date_incorporated: (raw.date_incorporated as string) || null,
    ...
    employer_name: (raw.legal_name as string) || (raw.trade_name as string) || null,
    legal_name: (raw.legal_name as string) || null,
    trading_name: (raw.trade_name as string) || null,
    employer_email: (raw.employer_email as string) || null,
    business_type: (raw.ownership_name as string) || (raw.ownership_code as string) || null,
    industry_type: (raw.industry_name as string) || (raw.activity_type_name as string) || null,
    tax_id: (raw.tax_id as string) || null,
    registration_date: (raw.date_incorporated as string) || (raw.application_date as string) || null,
    
    // Step 2: HQ Address - Map hq_address1 to address_line1
    address_line1: (raw.hq_address1 as string) || null,
    address_line2: (raw.hq_address2 as string) || null,
    ...
    mailing_address_line1: (raw.mailing_address1 as string) || null,
    mailing_address_line2: (raw.mailing_address2 as string) || null,
    ...
    phone: (raw.contact_telephone as string) || null,
    phone_country: (raw.contact_telephone_country as string) || null,
    phone_dial_code: (raw.contact_telephone_dial_code as string) || null,
    fax: (raw.contact_fax as string) || null,
    fax_country: (raw.contact_fax_country as string) || null,
    fax_dial_code: (raw.contact_fax_dial_code as string) || null,
    ...
    remarks: (raw.notes as string) || (raw.remarks as string) || null,
