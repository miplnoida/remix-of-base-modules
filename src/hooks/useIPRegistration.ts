  ...
  useEffect(() => {
    if (ipRecord) {
      const mappedData: IPMasterFormData = {
        ssn: ipRecord.ssn || '',
        surname: ipRecord.surname || '',
        firstname: ipRecord.firstname || '',
        middle_name: ipRecord.middle_name || '',
        second_middle_name: ipRecord.second_middle_name || '',
        previous_name: ipRecord.previous_name || '',
        alias: ipRecord.alias || '',
        sex: ipRecord.sex || '',
        dob: ipRecord.dob || '',
        birth_place: ipRecord.birth_place || '',
        nationality: ipRecord.nationality || '',
        marital_status: ipRecord.marital_status || '',
        heightfeet: ipRecord.heightfeet || null,
        heightinches: ipRecord.heightinches || null,
        eyecolor: ipRecord.eyecolor || '',
        name_prefix: ipRecord.name_prefix || '',
        name_suffix: ipRecord.name_suffix || '',
        resident_addr1: ipRecord.resident_addr1 || '',
        resident_addr2: ipRecord.resident_addr2 || '',
        district: ipRecord.district || '',
        mail_addr1: ipRecord.mail_addr1 || '',
        mail_addr2: ipRecord.mail_addr2 || '',
        email_addr: ipRecord.email_addr || '',
        ...
        work_permit: ipRecord.work_permit || 'N',
        primary_occup: ipRecord.primary_occup || '',
        npf: ipRecord.npf || 'N',
        application_date: ipRecord.application_date || new Date().toISOString().split('T')[0],
        date_of_residency: ipRecord.date_of_residency || '',
        place_of_residence: ipRecord.place_of_residence || '',
        citizenship_flag: ipRecord.citizenship_flag || ipRecord.citizenship || 'N',
        ip_signature: ipRecord.ip_signature || 'N',
        work_permit_expiration: ipRecord.work_permit_expiration || '',
