...
function baseP(overrides: Partial<RecipientPolicy> = {}): RecipientPolicy {
  return {
    ...
    singleConfiguredDisplayName: null,
    singleConfiguredDisplayNameSource: "unknown",
    singleConfiguredDisplayNameConfirmed: false,
    singleConfiguredDisplayNameConfirmedAt: null,
    singleConfiguredDisplayNameConfirmedBy: null,
