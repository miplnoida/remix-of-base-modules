          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <nav className="flex items-center space-x-2 text-sm text-muted-foreground">
                ...
                <span>/</span>
                <span className="text-foreground font-medium">Unemployment Benefits</span>
              </nav>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            <BriefcaseIcon className="h-8 w-8 text-warning" />
            <h1 className="text-3xl font-bold text-foreground">Unemployment Benefits</h1>
          </div>
                  ...
                  {[
                    ...
                    <div key={claim.id} className="flex items-center justify-between p-3 border rounded-lg">
                      ...
                      <div className="text-right">
                        ...
                        <p className={`text-xs ${
                          claim.status === 'Active' ? 'text-success' :
