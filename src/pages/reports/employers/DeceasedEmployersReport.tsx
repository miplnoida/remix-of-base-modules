...
const exportColumns: ExportColumn[] = [
  ...
  { header: 'Last Submission', key: 'lastSubmission', width: 18 },
  { header: 'Final Arrears (EC$)', key: 'finalArrears', width: 20 },
  { header: 'Officer Verified', key: 'officerVerified', width: 20 },
...
export default function DeceasedEmployersReport() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6" id="deceased-employers-report">
      <div className="flex justify-between items-start">
        ...
        />
        <ExportActions
          reportTitle="Deceased Employers"
          fileName="deceased-employers"
          data={mockData}
          columns={exportColumns}
          additionalInfo={[
            { label: 'Report Date', value: new Date().toLocaleDateString() },
            { label: 'Total Deceased', value: '30' },
            { label: 'With Arrears', value: '12' },
          ]}
        />
      </div>
