...
import { useC3ConfigPeriods, useCloneC3Config, useToggleC3ConfigActive, C3ConfigWithDetails } from '@/hooks/useC3ConfigManagement';
...
import { Loader2, Copy, Settings, Calendar, Eye } from 'lucide-react';
...
export default function C3PeriodConfigPage() {
  ...
  return (
    <PermissionWrapper moduleName="C3 Period Config">
      <div className="container mx-auto p-6 space-y-6">
        <div>
          <h1 className="text-2xl font-bold">C3 Period Configuration</h1>
          <p className="text-muted-foreground">
            Configure calculation parameters for different time periods. Clone existing configurations to create new periods.
          </p>
        </div>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Each period defines the calculation rules effective during that date range
                </CardDescription>
              </div>
            </div>
          </CardHeader>
