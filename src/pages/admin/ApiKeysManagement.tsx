...
import { Plus, Ban, BarChart3, RefreshCw, Smartphone } from 'lucide-react';
...
import MobileDevicesTab from '@/components/admin/api-management/MobileDevicesTab';
import ComplianceApiTab from '@/components/admin/api-management/ComplianceApiTab';
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage API keys, mobile devices, and Compliance Mobile API endpoints
          </p>
        </div>
      </div>
      ...
      <Tabs defaultValue="keys" className="w-full">
        <TabsList>
          ...
          <TabsTrigger value="devices">
            <Smartphone className="h-4 w-4 mr-1.5" /> Mobile Devices
          </TabsTrigger>
          <TabsTrigger value="compliance-api">Compliance API</TabsTrigger>
        </TabsList>
                      ...
                      <TableRow key={key.id}>
                        ...
                        <TableCell>
                          <div className="flex gap-1">
                            <Button size="icon" variant="ghost" onClick={() => fetchUsage(key.id)} title="View Usage">
        ...
        <TabsContent value="compliance-api">
          <ComplianceApiTab />
        </TabsContent>
      </Tabs>
