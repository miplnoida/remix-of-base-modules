...
import { TestTube, CheckCircle2, XCircle, AlertTriangle, Shield, Lock, User } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Test data access policies before deployment</p>
      </div>
