...
const BonusLevyExemptionsPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Bonus Levy Exemptions</h1>
          <p className="text-muted-foreground">
            Configure periods where bonus payments are exempt from levy
          </p>
        </div>
...
export default BonusLevyExemptionsPage;
