...
export const CORE_PERMISSION_DEFINITIONS: PermissionSourceDefinition[] = [
  ...
  { permission_key: 'core.admin.audit.view', permission_name: 'View Audit Log', module_code: 'CORE', domain_code: 'GOVERNANCE', permission_scope: 'PAGE', action_code: 'view', is_platform_permission: true, is_admin_permission: true, is_sensitive_permission: true, risk_level: 'MEDIUM', source_file: SF },
