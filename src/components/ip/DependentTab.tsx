                    ...
                    <CardContent className="pt-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
                        ...
                        <div className="col-span-1 flex flex-wrap gap-2 items-center justify-end">
                          {dependent.schoolChild && <span className="inline-block bg-secondary/10 text-secondary text-xs px-2 py-1 rounded">School Child</span>}
                          {dependent.invalid && <span className="inline-block bg-destructive/10 text-destructive text-xs px-2 py-1 rounded">Invalid</span>}
                          {dependent.dateOfDeath && <span className="inline-block bg-muted text-muted-foreground text-xs px-2 py-1 rounded">Deceased</span>}
                        </div>
                      </div>
                    </CardContent>
                  </Card>
