...
interface CreateCompliancePlanDialogProps {
  open: boolean;
...
export function CreateCompliancePlanDialog({ open, onOpenChange, employerId, totalAmount = 0 }: CreateCompliancePlanDialogProps) {
  ...
  const handleSubmit = () => {
    ...
    // TODO: Submit to backend via /compliance/plans
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Set up a compliance payment plan with installments
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            ...
            <Textarea
              id="terms"
              placeholder="Describe the payment plan terms (e.g., Monthly payments for arrears settlement)"
              value={terms}
