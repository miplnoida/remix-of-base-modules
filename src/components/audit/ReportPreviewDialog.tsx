              ...
              <div className="mb-8">
                ...
                {reportData.background && (
                  <div className="mb-4">
                    ...
                    <p className="text-sm leading-relaxed">{reportData.background}</p>
                  </div>
                )}
                {reportData.keyHighlights && (
                  <div className="mb-4">
                    <h4 className="font-semibold mb-2">Key Highlights</h4>
                    <p className="text-sm leading-relaxed">{reportData.keyHighlights}</p>
                  </div>
                )}
                {reportData.overallAssessment && (
                  <div className="mb-4">
                    <h4 className="font-semibold mb-2">Overall Assessment</h4>
                    <p className="text-sm leading-relaxed">{reportData.overallAssessment}</p>
                  </div>
                )}
              </div>
            )}
              ...
              <div className="mb-8">
                ...
                {reportData.objective && (
                  <div className="mb-4">
                    ...
                    <p className="text-sm leading-relaxed">{reportData.objective}</p>
                  </div>
                )}
                {reportData.scope && (
                  <div className="mb-4">
                    <h4 className="font-semibold mb-2">Scope</h4>
                    <p className="text-sm leading-relaxed">{reportData.scope}</p>
                  </div>
                )}
                {reportData.methodology && (
                  <div className="mb-4">
                    <h4 className="font-semibold mb-2">Methodology</h4>
                    <p className="text-sm leading-relaxed">{reportData.methodology}</p>
                  </div>
                )}
                {reportData.limitations && (
                  <div className="mb-4">
                    <h4 className="font-semibold mb-2">Limitations</h4>
                    <p className="text-sm leading-relaxed">{reportData.limitations}</p>
                  </div>
                )}
              </div>
            )}
                  ...
                  <div key={finding.id} className="mb-6 border-l-4 border-l-red-500 pl-4">
                    <div className="mb-3">
                      ...
                      <div className="flex gap-2 mt-2">
                        <span className={`text-xs px-2 py-1 rounded ${
                          finding.riskRating === 'High' ? 'bg-red-100 text-red-800' :
                          finding.riskRating === 'Medium' ? 'bg-yellow-100 text-yellow-800' :
                          'bg-green-100 text-green-800'
                        }`}>
                          Risk: {finding.riskRating}
                        </span>
                    ...
                    <div className="space-y-3 text-sm">
                      <div>
                        ...
                        <p className="mt-1">{finding.condition}</p>
                      </div>
                      <div>
                        <strong>Criteria:</strong>
                        <p className="mt-1">{finding.criteria}</p>
                      </div>
                      <div>
                        <strong>Cause:</strong>
                        <p className="mt-1">{finding.cause}</p>
                      </div>
                      <div>
                        <strong>Effect:</strong>
                        <p className="mt-1">{finding.effect}</p>
                      </div>
                    </div>
                  </div>
                ))}
                  ...
                  <div key={index} className="mb-6 border-l-4 border-l-blue-500 pl-4">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div>
                        ...
                        <p className="mt-1 whitespace-pre-line">{response.actionPlan}</p>
                      </div>
              ...
              <div className="mb-8">
                ...
                {reportData.conclusion && (
                  <div className="mb-4">
                    ...
                    <p className="text-sm leading-relaxed">{reportData.conclusion}</p>
                  </div>
                )}
                {reportData.followUpActions && (
                  <div className="mb-4">
                    <h4 className="font-semibold mb-2">Follow-up Actions</h4>
                    <p className="text-sm leading-relaxed">{reportData.followUpActions}</p>
                  </div>
                )}
              </div>
            )}
