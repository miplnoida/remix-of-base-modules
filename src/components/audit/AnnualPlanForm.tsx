...
export function AnnualPlanForm({ plan, onClose, onSuccess, onCreate, onUpdate }: AnnualPlanFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    totalAvailableDays: plan?.total_available_days || '',
    plannedWeeks: plan?.planned_weeks || '',
    contingencyDays: plan?.contingency_days || '',
  ...
  const mapToDbPayload = (status: string) => {
    const payload: any = {
      ...
      total_available_days: formData.totalAvailableDays ? Number(formData.totalAvailableDays) : null,
      planned_weeks: formData.plannedWeeks ? Number(formData.plannedWeeks) : null,
      contingency_days: formData.contingencyDays ? Number(formData.contingencyDays) : null,
