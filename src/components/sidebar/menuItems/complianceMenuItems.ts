...
const administration: SubItem = {
  ...
  subItems: filterEnabled<SubItem & { __feature?: string }>([
    ...
    { title: "Notice Templates", url: "/compliance/admin/report-templates", icon: FileText, requiresPermission: "manage_compliance" },
    { title: "Communication Templates", url: "/compliance/admin/communication-templates", icon: Mail, requiresPermission: "manage_compliance" },
