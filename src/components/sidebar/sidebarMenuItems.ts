...
export const menuItems = [
  ...
  },
  {
    ...
    icon: BarChart3,
    subItems: [
      { title: "Claims Administration", url: "/reports/claims", icon: FileText },
      { title: "Cashier Reports", url: "/reports/cashier", icon: Receipt },
      { title: "Employer Administration", url: "/reports/employer", icon: Building2 },
      { title: "Insured Persons", url: "/reports/persons", icon: Users },
      { title: "Statistics", url: "/reports/statistics", icon: PieChart },
