...
export const SKN_BENEFIT_BASELINE: SknBenefitBaseline[] = [
  ...
  // ─── Service Cases (no contribution/calculation logic) ───────────
  {
    benefit_code: 'SKN-SVC-LIFE-CERT',
    benefit_name: 'Life Certificate (Pensioner Service)',
    category: 'SERVICE',
    requires_active_version: true,
    ...
    expected_documents: ['LIFE_CERT', 'ID_CARD'],
    expected_calculation_notes: 'No calculation — pensioner liveness confirmation.',
    warnings: ['Annual re-certification cadence must be configured.'],
    test_cases: [],
  },
  {
    benefit_code: 'SKN-SVC-SCHOOL-CERT',
    benefit_name: 'School Certificate (Survivor Child Service)',
    category: 'SERVICE',
    requires_active_version: true,
    requires_eligibility: false,
    requires_calculation: false,
    ...
    requires_timeline: false,
    expected_eligibility_keys: [],
    expected_documents: ['SCHOOL_CERT'],
    expected_calculation_notes: 'No calculation — confirms continued education for survivor child (age 18–21).',
    warnings: ['Renewal cadence (per academic term) must be configured.'],
    test_cases: [],
  },
  {
    benefit_code: 'SKN-SVC-EFT-UPDATE',
    benefit_name: 'EFT / Bank Account Update (Beneficiary Service)',
    category: 'SERVICE',
    requires_active_version: true,
    requires_eligibility: false,
    requires_calculation: false,
    ...
    requires_timeline: false,
    expected_eligibility_keys: [],
    expected_documents: ['BANK_EFT', 'ID_CARD'],
    expected_calculation_notes: 'No calculation — banking detail change request.',
    warnings: ['Dual-control / supervisor approval should be enforced.'],
    test_cases: [],
  },
];
