...
export async function saveCalculationSnapshot(
  ...
  const snapshotData = {
    ...
    weekly_rate: calcOutput.formulaResult?.adjustedResult ?? calcOutput.formulaResult?.rawResult ?? null,
    lump_sum: null,
    total_payable: calcOutput.formulaResult?.adjustedResult ?? calcOutput.formulaResult?.rawResult ?? null,
