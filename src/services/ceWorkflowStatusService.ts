...
export type CeEntityType = 'violation';
// Extend with 'case' | 'notice' | 'arrangement' | 'legal_referral'
// | 'legal_recommendation' | 'inspection' | 'breach' | 'waiver' as each
// is added to ce_apply_status_transition + seed.
