...
export const BN_MORTALITY_COMMANDS: readonly BnMortalityCommandSpec[] = [
  ...
  { command: 'BN_MORTALITY_PLACE_PROVISIONAL_HOLD',       capability: 'bn_mortality:decide',           requiresMakerChecker: false, transactional: true,  requiresJustification: true,  implemented: false, blocker: 'BN-MORT-2B.2A acceptance pending: server orchestration, DB-driven integration tests and query DTO certification.' },
  { command: 'BN_MORTALITY_RELEASE_HOLD',                 capability: 'bn_mortality:decide',     requiresMakerChecker: false, transactional: true,  requiresJustification: true,  implemented: false, blocker: 'BN-MORT-2B.2A acceptance pending: server orchestration, DB-driven integration tests and query DTO certification.' },
  ...
  { command: 'BN_MORTALITY_PREPARE_IMPACT',               capability: 'bn_mortality:write',   requiresMakerChecker: false, transactional: true,  requiresJustification: false, implemented: false, blocker: 'BN-MORT-2B.2A acceptance pending: server orchestration, DB-driven integration tests and query DTO certification.' },
  ...
  { command: 'BN_MORTALITY_TERMINATE_AWARD',              capability: 'bn_mortality:decide',           requiresMakerChecker: true,  transactional: true,  requiresJustification: true,  implemented: false, blocker: 'BN-MORT-2B.2A acceptance pending: server orchestration, DB-driven integration tests and query DTO certification.' },
