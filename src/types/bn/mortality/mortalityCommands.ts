...
export const BN_MORTALITY_COMMANDS: readonly BnMortalityCommandSpec[] = [
  ...
  { command: 'BN_MORTALITY_RELEASE_HOLD',                 capability: 'bn_mortality:decide',     requiresMakerChecker: false, transactional: true,  requiresJustification: true,  implemented: false, blocker: 'BN-MORT-2B.1 §4 — Award/Payment servicing reversal boundary not invoked.' },
