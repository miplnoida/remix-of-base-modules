...
export const BN_MORTALITY_COMMANDS: readonly BnMortalityCommandSpec[] = [
  { command: 'BN_MORTALITY_DRAFT_SAVE',                   capability: 'bn_mortality:write',          requiresMakerChecker: false, transactional: false, requiresJustification: false, implemented: false },
  ...
  { command: 'BN_MORTALITY_CANCEL',                       capability: 'bn_mortality:write',          requiresMakerChecker: false, transactional: false, requiresJustification: true,  implemented: false },
  { command: 'BN_MORTALITY_MATCH_PERSON',                 capability: 'bn_mortality:write',          requiresMakerChecker: false, transactional: false, requiresJustification: false, implemented: false },
  { command: 'BN_MORTALITY_MARK_DUPLICATE',               capability: 'bn_mortality:write',          requiresMakerChecker: false, transactional: false, requiresJustification: true,  implemented: false },
  { command: 'BN_MORTALITY_ASSIGN',                       capability: 'bn_mortality:write',          requiresMakerChecker: false, transactional: false, requiresJustification: false, implemented: false },
  ...
  { command: 'BN_MORTALITY_RELEASE_HOLD',                 capability: 'bn_mortality:decide',         requiresMakerChecker: false, transactional: true,  requiresJustification: true,  implemented: false },
  ...
  { command: 'BN_MORTALITY_RESOLVE_CONFLICT',             capability: 'bn_mortality:decide',         requiresMakerChecker: false, transactional: false, requiresJustification: true,  implemented: false },
  ...
  { command: 'BN_MORTALITY_PREPARE_IMPACT',               capability: 'bn_mortality:write',          requiresMakerChecker: false, transactional: false, requiresJustification: false, implemented: false },
  { command: 'BN_MORTALITY_SUBMIT_IMPACT',                capability: 'bn_mortality:write',          requiresMakerChecker: false, transactional: false, requiresJustification: false, implemented: false },
  { command: 'BN_MORTALITY_RETURN_IMPACT',                capability: 'bn_mortality:decide',         requiresMakerChecker: false, transactional: false, requiresJustification: true,  implemented: false },
  ...
  { command: 'BN_MORTALITY_COMPLETE_FOLLOWON',            capability: 'bn_mortality:decide',         requiresMakerChecker: false, transactional: false, requiresJustification: false, implemented: false },
