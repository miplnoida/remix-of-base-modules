...
export const BN_MORTALITY_COMMANDS: readonly BnMortalityCommandSpec[] = [
  ...
  { command: 'BN_MORTALITY_MATCH_PERSON',                 capability: 'bn_mortality:write',          requiresMakerChecker: false, transactional: false, requiresJustification: false, implemented: true },
  ...
  { command: 'BN_MORTALITY_ATTACH_EVIDENCE',              capability: 'bn_mortality:write',          requiresMakerChecker: false, transactional: false, requiresJustification: false, implemented: true },
  ...
  { command: 'BN_MORTALITY_PREPARE_IMPACT',               capability: 'bn_mortality:write',          requiresMakerChecker: false, transactional: false, requiresJustification: false, implemented: true },
  ...
  { command: 'BN_MORTALITY_TERMINATE_AWARD',              capability: 'bn_mortality:decide',         requiresMakerChecker: true,  transactional: true,  requiresJustification: true,  implemented: true },
  { command: 'BN_MORTALITY_CREATE_PAD_OVERPAYMENT',       capability: 'bn_mortality:decide',         requiresMakerChecker: true,  transactional: true,  requiresJustification: true,  implemented: true },
  { command: 'BN_MORTALITY_INITIATE_SURVIVOR_ASSESSMENT', capability: 'bn_mortality:write',          requiresMakerChecker: false, transactional: false, requiresJustification: false, implemented: true },
  { command: 'BN_MORTALITY_INITIATE_FUNERAL_GRANT',       capability: 'bn_mortality:write',          requiresMakerChecker: false, transactional: false, requiresJustification: false, implemented: true },
  { command: 'BN_MORTALITY_COMPLETE_FOLLOWON',            capability: 'bn_mortality:decide',         requiresMakerChecker: false, transactional: false, requiresJustification: false, implemented: true },
  { command: 'BN_MORTALITY_REFER_LEGAL',                  capability: 'bn_mortality:decide',         requiresMakerChecker: true,  transactional: false, requiresJustification: true,  implemented: true },
  ...
  { command: 'BN_MORTALITY_CLOSE_EVENT',                  capability: 'bn_mortality:decide',         requiresMakerChecker: false, transactional: false, requiresJustification: false, implemented: true },
] as const;
