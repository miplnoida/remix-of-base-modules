...
export const BN_MORTALITY_COMMANDS: readonly BnMortalityCommandSpec[] = [
  ...
  { command: 'BN_MORTALITY_PREPARE_IMPACT',               capability: 'bn_mortality:write',   requiresMakerChecker: false, transactional: true,  requiresJustification: false, implemented: true },
