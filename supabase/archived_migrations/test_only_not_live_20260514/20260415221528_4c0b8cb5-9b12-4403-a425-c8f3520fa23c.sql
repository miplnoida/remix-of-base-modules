...
BEGIN
  ...
  FOR v_location IN SELECT * FROM jsonb_array_elements(p_locations_json::JSONB) LOOP
    ...
    INSERT INTO er_locations (
      ...
      v_regno, v_location_id,
      v_location->>'trade_name', v_location->>'loc_addr1', v_location->>'loc_addr2',
  ...
  -- Audit trail using correct column names matching system_audit_trail schema
  INSERT INTO system_audit_trail (
    action, module, entity_type, entity_id, payload_json, user_name, created_at
  ) VALUES (
    'CONVERT_APPLICATION',
