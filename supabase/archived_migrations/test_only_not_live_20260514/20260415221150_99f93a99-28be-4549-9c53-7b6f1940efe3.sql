...
-- 1. Create er_documents table
CREATE TABLE IF NOT EXISTS public.er_documents (
...
DROP FUNCTION IF EXISTS public.convert_application_to_employer(
  TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, INTEGER, INTEGER, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT
);

-- 3. Recreate with regex fix for T-series generation
...
BEGIN
  ...
  -- FIX: Use regex '^T\d{5}$' instead of LIKE 'T%' to avoid matching TE0030 etc.
  SELECT COALESCE(
