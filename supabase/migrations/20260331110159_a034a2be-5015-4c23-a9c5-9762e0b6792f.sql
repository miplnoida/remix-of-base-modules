...
-- ============================================================
-- FIX: public_api_er_master_details
-- Changes: mobile→v_rec.mobile, add fax, add country
-- ============================================================
...
-- ============================================================
-- FIX: public_api_se_master_details
-- Changes: mobile→v_ip.phone_mobile, add country, add selfRefNo, city→district
-- ============================================================
...
BEGIN
  ...
  -- Require ip_self_employ record exists
  SELECT * INTO v_se
  FROM ip_self_employ
  WHERE TRIM(ssn) = TRIM(p_ssn)
