...
-- Drop BOTH conflicting signatures
DROP FUNCTION IF EXISTS public.get_c3_records_filtered(text, text, text, text, text, integer, integer, text, text, integer, integer, integer, boolean);
DROP FUNCTION IF EXISTS public.get_c3_records_filtered(text, text, text, text, text, integer, integer, text, text, integer, boolean, integer, integer);

-- Recreate the single canonical version with original parameter order
