...
-- Recreate public_api_payment_save: remove manual receipt_number generation, let trigger handle it
...
BEGIN
  ...
  -- Fetch the trigger-generated receipt_number (trigger fires AFTER INSERT and updates the row)
