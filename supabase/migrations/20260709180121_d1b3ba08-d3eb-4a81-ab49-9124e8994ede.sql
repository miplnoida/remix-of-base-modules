...
VALUES
  ('dry_run_only', to_jsonb(false), to_jsonb(true), 'B8-D-B aborted (preview signed out) — gates reverted', 'phase-1c-b8-d-b'),
  ('email_live_enabled', to_jsonb(true), to_jsonb(false), 'B8-D-B aborted (preview signed out) — gates reverted', 'phase-1c-b8-d-b');
