...
BEGIN
  ...
  INSERT INTO ip_master (
    ...
    -- Personal
    first_name, last_name, middle_name, second_middle_name, gender, date_of_birth, 
    ...
    -- Personal
    p_first_name, p_last_name, p_middle_name, p_second_middle_name, COALESCE(p_gender, 'N'), p_date_of_birth,
