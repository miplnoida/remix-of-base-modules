...
-- Recreate public_api_payment_save with corrected c3_payment_components column names
...
BEGIN
  ...
  LOOP
    ...
    -- Fixed: use correct column names matching c3_payment_components schema
