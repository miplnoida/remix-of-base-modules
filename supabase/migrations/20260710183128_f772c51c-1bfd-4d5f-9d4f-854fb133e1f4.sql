...
BEGIN
  ...
  -- Sender verified? Uses real column names on communication_hub_sender_profile.
  -- sender_profile is not per-module in the current schema; require at least
  -- one enabled + verified + domain-verified profile to exist.
