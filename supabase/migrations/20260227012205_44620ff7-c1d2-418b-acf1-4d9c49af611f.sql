...
BEGIN
  ...
  -- c3_bonus_policy_exceptions has text date columns, so cast explicitly
  ...
  IF v_days_late > 0 THEN
    -- Levy Penalty base = employee_levy + employer_levy ONLY
    ...
    -- SS Fine base = employee_ss + employer_ss_total
