...
BEGIN
  ...
  -- Acquire advisory lock to safely generate next payment_id (different key from internal RPC)
  ...
  -- Generate text-based receipt number (receipts use text)
  ...
  -- Insert payment header with bigint payment_id
